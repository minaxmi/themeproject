...
<li id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="post-content">		
        ...
        <a href="<?php echo esc_url( get_permalink() );?>"><img src="<?php echo esc_url($url); ?>" class="img-responsive width100" alt="<?php esc_html_e('blog','wander');?>"></a>
        <?php } ?>       
        <div class="post-text">
        	<?php
				if ( is_single() ) {
        ...
        <a class="read-more-link btn-appear" href="<?php echo esc_url( get_permalink() );?>"><span><?php esc_html_e('Read More', 'wander')?> <i class="ion-android-arrow-forward"></i></span></a>   
    </div>	
</li>
