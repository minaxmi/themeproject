...
}elseif($type=='container_fluid'){
	$html_container ='<div class="container-fluid">';
	$html_container_end ='</div>';
}else{
	$html_container ='';
	$html_container_end ='';
...
if($type=='vertical_align'){
	$html_vertical_align ='<div class="vertical-align">';
	$html_vertical_align_end ='</div>';
}else{
	$html_vertical_align ='';
	$html_vertical_align_end ='';
}
...
}elseif($no_padding_margin){
	$output .= '<div class="row team-fullwidth">';
}else{
	$output .= '<div class="row">';
}


$output .= $html_vertical_align;
$output .= wpb_js_remove_wpautop( $content );
$output .= $html_vertical_align_end;
$output .= '</div>';
