<?php
/**
 * Template name: Demo Template for Ion Icons
 *
...
get_header(); ?>
  <!-- Page Hero -->
            ...
            <div class="page-title-content"> 
                <div class="container">   
                    <div class="col-sm-12 text-center">
                        <h1 class="white-until-load">Ion Icons</h1>
                        <hr class="separator">
                        <h5 class="subheading white-until-load">The premium icon font</h5> 
                    </div> 
                </div>
            </div>    
        </section>
        ...
        <section class="pt120 pb100">
            <div class="container ion-icons-list text-center"> 

                <div class="col-md-12 text-center mb20">
                    <p>You can place icons just about anywhere with the &lt;i> tag:</p>
                    <div class="icons-pre">
                        <pre><code><span class="nt">&lt;i class="ion-lock-combination">&lt;/i></span></code></pre>
                        <p><i class="ion-lock-combination size-2x ion-icon-list-promo"></i></p>
                    </div>
                </div>
                ...
                <ul id="icons" class="ion-icons-list">
